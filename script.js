...
$('.nature-a').on('mouseover',function(){
  $('.nature-img').css('border', '2px solid #378EDB');
...
$('.spot-a').on('mouseover',function(){
  $('.spot-img').css('border', '2px solid #378EDB');
...
$('.eat-a').on('mouseover',function(){
  $('.eat-img').css('border', '2px solid #378EDB');
...
$('.culture-a').on('mouseover',function(){
  $('.culture-img').css('border', '2px solid #378EDB');
...
$('.history-a').on('mouseover',function(){
  $('.history-img').css('border', '2px solid #378EDB');
